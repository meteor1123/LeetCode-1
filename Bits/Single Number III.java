...
/*
    ...
    In the first pass, 
    	we XOR all elements in the array, and get the XOR of the two numbers we need to find. 
    ...
    In the second pass, 
    	we divide all numbers into two groups, one with the aforementioned bit set, 
